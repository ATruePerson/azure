...
const rule = createOxlintRuleHarness("azure/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("azure/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("azure/no-manual-effect-runtime-in-tests");
