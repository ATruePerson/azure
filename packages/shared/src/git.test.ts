import type { VcsStatusRemoteResult, VcsStatusResult } from "@azure/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:T3Tools/AzureCode.git")).toBe(
      "github.com/azure/azure",
    );
    expect(normalizeGitRemoteUrl("https://github.com/T3Tools/AzureCode.git")).toBe(
      "github.com/azure/azure",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/T3Tools/AzureCode")).toBe(
      "github.com/azure/azure",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:T3Tools/platform/AzureCode.git")).toBe(
      "gitlab.com/azure/platform/azure",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/T3Tools/platform/AzureCode.git")).toBe(
      "gitlab.com/azure/platform/azure",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:T3Tools/AzureCode.git"),
    ).toBe("T3Tools/AzureCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/T3Tools/AzureCode.git"),
    ).toBe("T3Tools/AzureCode");
  });
});
