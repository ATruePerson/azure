...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Azure Code spawn the server when needed.",
        providerSettingsForm: {
...
export const NvidiaNimSettings = makeProviderSettingsSchema(
  {
    ...
    baseUrl: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed(NVIDIA_NIM_DEFAULT_BASE_URL)),
      Schema.annotateKey({
        title: "Base URL",
        description: "NVIDIA OpenAI-compatible API endpoint.",
        providerSettingsForm: {
          placeholder: NVIDIA_NIM_DEFAULT_BASE_URL,
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    chatgptWeb: CodexSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
const ChatGptWebSettingsPatch = CodexSettingsPatch;
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  providers: Schema.optionalKey(
    Schema.Struct({
      ...
      chatgptWeb: Schema.optionalKey(ChatGptWebSettingsPatch),
