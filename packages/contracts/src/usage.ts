 ...
 * relying on Azure Code's own orchestration projections, so usage stays complete
 * even for turns that were never driven through Azure Code. This mirrors the
