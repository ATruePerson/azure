...
>()("@azure/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@azure/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@azure/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@azure/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
