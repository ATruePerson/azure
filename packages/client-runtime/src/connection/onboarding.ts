import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@azure/contracts";
import { resolveRemotePairingTarget } from "@azure/shared/remote";
...
>()("@azure/client-runtime/connection/onboarding/ConnectionOnboarding") {}
