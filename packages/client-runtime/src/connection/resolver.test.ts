import { EnvironmentId, type DesktopSshEnvironmentTarget } from "@azure/contracts";
import { RelayEnvironmentConnectScope } from "@azure/contracts/relay";
import { RelayClientTracer } from "@azure/shared/relayTracing";
