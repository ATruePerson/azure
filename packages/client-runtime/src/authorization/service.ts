import { EnvironmentId, type ExecutionEnvironmentDescriptor } from "@azure/contracts";
import type { RelayManagedEndpoint } from "@azure/contracts/relay";
import {
...
>()("@azure/client-runtime/authorization/service/RemoteEnvironmentAuthorization") {}
