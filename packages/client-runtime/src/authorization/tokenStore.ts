...
import { RelayManagedEndpoint } from "@azure/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@azure/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@azure/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
