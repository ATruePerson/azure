...
import { RelayEnvironmentConnectScope, RelayEnvironmentStatusScope } from "@azure/contracts/relay";
...
>()("@azure/client-runtime/relay/discovery/RelayEnvironmentDiscovery") {}
