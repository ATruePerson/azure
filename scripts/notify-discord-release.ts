  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Azure Code prerelease is available for nightly testers."
          : "A new Azure Code latest release is available.",
...
).pipe(Command.withDescription("Post a Azure Code release announcement to Discord."));
