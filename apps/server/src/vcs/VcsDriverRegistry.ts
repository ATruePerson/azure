...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@azure/contracts";
import { VcsUnsupportedOperationError } from "@azure/contracts";
