...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@azure/shared/git";
import { compactTraceAttributes } from "@azure/shared/observability";
import { decodeJsonResult } from "@azure/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `azure-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
