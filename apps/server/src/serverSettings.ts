...
import { type DeepPartial, deepMerge } from "@azure/shared/Struct";
import { fromJsonStringPretty, fromLenientJson } from "@azure/shared/schemaJson";
import { applyServerSettingsPatch } from "@azure/shared/serverSettings";
import * as ServerSecretStore from "./auth/ServerSecretStore.ts";

export { resolveSourceControlWriterModelSelection } from "@azure/shared/serverSettings";
...
>()("azure/serverSettings/ServerSettingsService") {
