import { ProjectId } from "@azure/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@azure/shared/projectScripts";
...
>()("azure/project/ProjectSetupScriptRunner") {}
