...
import { T3_PROJECT_FILE_NAME, type T3ProjectFile } from "@azure/contracts";
import { T3ProjectFileFromJson } from "@azure/shared/t3ProjectFile";
...
>()("azure/project/T3ProjectFileLoader") {}
