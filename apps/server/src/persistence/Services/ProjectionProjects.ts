 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@azure/contracts";
...
>()("azure/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
