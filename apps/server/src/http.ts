...
import { isDevProxiedPath } from "@azure/shared/devProxy";
import { decodeOtlpTraceRecords } from "@azure/shared/observability";
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // AZURE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
