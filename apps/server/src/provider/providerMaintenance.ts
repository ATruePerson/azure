...
import { compareSemverVersions } from "@azure/shared/semver";
import { resolveCommandPath } from "@azure/shared/shell";
...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "@azure/server/providerMaintenance/ProviderVersionCache",
  {
