...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverGetCodexCapabilities]: AuthOrchestrationReadScope,
  [WS_METHODS.serverSetCodexSkillEnabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSetCodexConfigEnabled]: AuthOrchestrationOperateScope,
