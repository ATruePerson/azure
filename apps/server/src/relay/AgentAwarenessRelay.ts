...
import { projectThreadAwareness } from "@azure/shared/agentAwareness";
import { makeDrainableWorker } from "@azure/shared/DrainableWorker";
...
>()("azure/relay/AgentAwarenessRelay") {}
