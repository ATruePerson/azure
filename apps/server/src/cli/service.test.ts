...
const status = {
  ...
  installed: true,
  current: true,
  unitPath: "/home/me/.config/systemd/user/azure.service",
  logPath: "/home/me/.azure/userdata/logs/boot-service.log",
} as const;
...
it("reports the installed service version and host paths", () => {
  assert.equal(
    ...
    [
      ...
      "  Unit: /home/me/.config/systemd/user/azure.service",
      "  Logs: /home/me/.azure/userdata/logs/boot-service.log",
    ].join("\n"),
  );
});
...
it("gives a direct repair command for a stale service", () => {
  assert.include(
    ...
    "Next: Run `npx azure@latest service update`.",
  );
});
