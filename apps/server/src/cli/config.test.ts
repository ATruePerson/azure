            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  AZURE_DEV_ALLOWED_ORIGINS:
                    "https://host.example.ts.net, https://phone.example.ts.net ",
                  AZURE_NO_BROWSER: "true",
                  AZURE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  AZURE_LOG_WS_EVENTS: "true",
                },
              }),
            ),
            NetService.layer,
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  AZURE_PORT: "4001",
                  AZURE_HOST: "0.0.0.0",
                  AZURE_HOME: join(NodeOS.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  AZURE_NO_BROWSER: "false",
                  AZURE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  AZURE_LOG_WS_EVENTS: "false",
                },
              }),
            ),
            NetService.layer,
        ...
        Effect.provide(
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  AZURE_BOOTSTRAP_FD: String(fd),
                  AZURE_NO_BROWSER: "true",
                  AZURE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  AZURE_LOG_WS_EVENTS: "true",
                },
              }),
            ),
