import { readConnectAuthorizeRequest } from "@azure/shared/connectAuth";
...
const TEST_ENV = {
  AZURE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  AZURE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  AZURE_HOSTED_APP_URL: "https://hosted.example.test",
};
