import type { ServerSelfUpdateOutcome } from "@azure/contracts";
import { HostProcessEnvironment } from "@azure/shared/hostProcess";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "azure/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("azure/cloud/serviceLauncherClient") {}
