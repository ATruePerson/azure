...
import { SourceControlProviderError, type ChangeRequest } from "@azure/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set AZURE_BITBUCKET_EMAIL and AZURE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
