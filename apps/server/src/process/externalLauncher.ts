...
import { isCommandAvailable, resolveSpawnCommand } from "@azure/shared/shell";
...
// per-command cache lookups in @azure/shared/shell.
//
...
// command-resolution cache in @azure/shared/shell, so a backward wall-clock
...
>()("azure/process/externalLauncher") {}
