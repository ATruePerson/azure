...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@azure/shared/path";
import { normalizeSearchQuery } from "@azure/shared/searchRanking";
...
>()("azure/workspace/WorkspaceEntries") {}
