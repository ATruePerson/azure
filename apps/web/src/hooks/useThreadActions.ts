...
import { settlePromise, squashAtomCommandFailure } from "@azure/client-runtime/state/runtime";
import { canSettle, canSnooze, threadWokeAt } from "@azure/client-runtime/state/thread-settled";
import { EnvironmentId, type ScopedThreadRef, ThreadId } from "@azure/contracts";
