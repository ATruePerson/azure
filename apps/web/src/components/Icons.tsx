...
export const NvidiaIcon: Icon = (props) => (
  <svg {...props} viewBox="215 523 2070 392" fill="none" aria-hidden="true">
    <path
      fill="#76B900"
...
export const OpenRouterIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 401.4 293.7" fill="none" aria-hidden="true">
    <path
      fill="#7624F4"
