import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@azure/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/azure/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/azure"
      />,
    );

    expect(markup).toContain("azure/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/azure/apps/web/src/session-logic.ts");
  });
