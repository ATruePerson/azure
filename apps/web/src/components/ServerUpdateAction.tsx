import type { EnvironmentId, ServerSelfUpdateCapability } from "@azure/contracts";
import type { ServerUpdateStage, ServerUpdateState } from "@azure/client-runtime/state/server";
import {
