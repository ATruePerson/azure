import type { LocalApi, ScopedThreadRef } from "@azure/contracts";
import { isAtomCommandInterrupted } from "@azure/client-runtime/state/runtime";
import { isPreviewableUrl } from "@azure/shared/preview";
