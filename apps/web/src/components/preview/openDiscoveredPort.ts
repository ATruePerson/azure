import type { DiscoveredLocalServer, ScopedThreadRef } from "@azure/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@azure/client-runtime/state/runtime";
