...
import { isWorkspaceImagePreviewPath } from "@azure/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "azure.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "azure.renderMarkdown";
