...
import type { EnvironmentPresentation } from "@azure/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@azure/client-runtime/state/presentation";
