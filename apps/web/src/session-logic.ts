...
import { isBackgroundTaskActivity } from "@azure/client-runtime/state/subagentRuntime";
import {
  ApprovalRequestId,
...
export const PROVIDER_OPTIONS: Array<{
  ...
  { value: ProviderDriverKind.make("chatgptWeb"), label: "ChatGPT Web", available: true },
