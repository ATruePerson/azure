...
import { resolveAssetUrl } from "@azure/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@azure/contracts";
...
export { resolveAssetUrl } from "@azure/client-runtime/state/assets";
