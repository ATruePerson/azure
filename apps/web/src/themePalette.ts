...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  canvas: "#fdf7fd",
  // Azure's workspace header belongs to the chat panel, so keep it seamless
  ...
  // dark plum pair here also leaked the dark palette into Azure's diffs.
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  // Diffs and file previews are full workspace surfaces in Azure. Keep them
...
/**
 * The palette Azure wears with no theme installed, captured from the app's
...
/**
 * The standard Azure look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Azure shows without a theme, read from the app's own
