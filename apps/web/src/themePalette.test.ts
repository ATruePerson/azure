...
describe("theme files", () => {
  it("derives a readable palette from extreme simple-editor colors", () => {
    ...
    // Status colors fall back to Azure Code's standard red and amber rather than
  ...
  it("keeps the Azure Chat palette faithful and readable", () => {
...
describe("stored theme preferences", () => {
  ...
  it("resolves the legacy t3-chat-dark preference to dark Azure Chat", () => {
