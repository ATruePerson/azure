import { type ServerLifecycleWelcomePayload } from "@azure/contracts";
import { scopedProjectKey, scopeProjectRef } from "@azure/client-runtime/environment";
import { squashAtomCommandFailure } from "@azure/client-runtime/state/runtime";
import {
  Outlet,
  createRootRoute,
