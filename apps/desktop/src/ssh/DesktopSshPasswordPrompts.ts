import type { DesktopSshPasswordPromptRequest } from "@azure/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@azure/contracts";
import type { SshPasswordRequest } from "@azure/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Azure window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@azure/desktop/ssh/DesktopSshPasswordPrompts") {}
