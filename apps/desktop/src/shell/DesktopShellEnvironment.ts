...
>()("@azure/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__AZURE_ENV_${name}_START__`;
const endMarker = (name: string) => `__AZURE_ENV_${name}_END__`;
