import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@azure/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@azure/shared/observability";
...
>()("@azure/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
