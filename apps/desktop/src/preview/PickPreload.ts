...
const OVERLAY_ATTRIBUTE = "data-azure-annotation-ui";
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-azure-annotation-tool", tool);
  };
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-azure-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
