...
import { ConnectionTransientError } from "@azure/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "azure.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "azure.connections";
