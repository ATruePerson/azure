import type { EnvironmentRpcSubscriptionObservation } from "@azure/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@azure/contracts";
