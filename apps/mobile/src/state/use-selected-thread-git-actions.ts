...
import { EnvironmentProject, EnvironmentThreadShell } from "@azure/client-runtime/state/shell";
import type { AtomCommandResult } from "@azure/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@azure/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@azure/contracts";
import { dedupeRemoteBranchesWithLocalMatches, sanitizeFeatureBranchName } from "@azure/shared/git";
