...
import type { SidebarProjectGroupingMode } from "@azure/contracts";

import * as MobileDatabase from "./mobile-database";
import * as MobileSecureStorage from "./mobile-secure-storage";
import { MobileStorageDecodeError, MobileStorageEncodeError } from "./mobile-storage";

const PREFERENCES_KEY = "azure.preferences";
const PREFERENCES_FALLBACK_KEY = "azure.preferences.fallback";
...
>()("@azure/mobile/persistence/MobilePreferencesStore") {}
