...
import { scopeThreadRef } from "@azure/client-runtime/environment";
import { EnvironmentProject } from "@azure/client-runtime/state/shell";
import { mapAtomCommandResult } from "@azure/client-runtime/state/runtime";
import {
  ThreadId,
  type ModelSelection,
