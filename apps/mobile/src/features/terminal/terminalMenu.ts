import { type KnownTerminalSession } from "@azure/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@azure/contracts";
...
} from "@azure/shared/terminalLabels";
