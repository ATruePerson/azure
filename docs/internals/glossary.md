...
This is a living glossary for Azure Code. It explains what common terms mean in this codebase.
...
The backend agent runtime that actually performs work. Six drivers ship built in: Codex, ChatGPT Web, Claude, Cursor, Grok, and OpenCode. See [ProviderService.ts][14], [ProviderAdapter.ts][15], and [CodexAdapter.ts][17] as a representative adapter.
