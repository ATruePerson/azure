...
Azure Code is a server runtime that owns agent sessions, workspaces, and version control, plus clients
...
Codex, ChatGPT Web, Claude, Cursor, Grok, and OpenCode. A driver declares its kind and config schema and creates a
